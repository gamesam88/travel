...
(function () {
    ...
    burgeMenu.addEventListener("click", (event) => {
        if (event.target.classList.contains('burger-menu')) {
            ...
            setTimeout(() => {
                document.getElementById('burger-menu').style.transform = "translate(390px)"
    ...
    const arrowRigth = document.querySelector('.destinations-mobile-arrow-rigth-img')
    const arrowLeft = document.querySelector('.destinations-mobile-arrow-left-img')
